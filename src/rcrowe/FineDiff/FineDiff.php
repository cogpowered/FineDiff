...
class FineDiff
{
    ...
    */
    public static function renderDiffToHTMLFromOpcodes($from, $opcodes) {
        ob_start();
        FineDiff::renderFromOpcodes($from, $opcodes, array('rcrowe\FineDiff\FineDiff', 'renderDiffToHTMLFromOpcodeTwo'));
        return ob_get_clean();
    }
    ...
    */
    ...
    public static function renderDiffToHTMLFromOpcodeTwo($opcode, $from, $from_offset, $from_len)
    {
        if ($opcode === 'c') {
